...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String caminhodocsv = "/tmp/games.csv"; // lembrar de ajustar se necessário
        int totalLidos = 0;
        ...
        quicksort(arraySelecionados, 0, arraySelecionados.length - 1);
        ...
        try (PrintWriter log = new PrintWriter("885761_quicksort.txt")) {
    ...
    public static void quicksort(Game[] arr, int esq, int dir) {
        int i = esq, j = dir;
